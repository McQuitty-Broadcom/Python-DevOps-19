...
- Your login: is mfwsuser19@demo.broadcom.com
...
- Your userid is CUST019.
- Your password CUST019.
...
- Run the following commands and ensure we get a 0000 return code:
  - `zowe endevor generate DOGGOS19 --type COBOL --os --maxrc 0 --sn 1 --cb`
  - `zowe endevor generate DOGGOS19 --type LNK --os --maxrc 0 --sn 1 --cb`
...
- To execute the application and see the output, we can call `zowe jobs`.
  - `zowe jobs submit dataset CUST019.PUBLIC.JCL(NDRUNDOG) --vasc`
...
`zowe jobs submit data-set "CUST019.MARBLES.JCL(MARBCOPY)" --vasc`
...
Username: _JENKINSCUST019
Password: Mfuser19@26
...
The repository URL will be `https://github.com/McQuitty-Broadcom/Python-DevOps-19.git`
